(function () {
   ...
   *原型轨迹
   */
  let gitMove = document.getElementById("xhc_a");
  let weiboMove = document.getElementById("mw_a");
  let blogMove = document.getElementById("dsn_a");
  let g_num = 0;
  let w_num = 0;
  let b_num = 0;
...
let e_li = document.getElementById("timeUl").children;
let li_times = 0;
